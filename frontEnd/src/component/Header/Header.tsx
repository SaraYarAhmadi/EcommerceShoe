...
export default function Header() {
  ...
  return (
    <>
      {/* header */}
      <header className='fixed w-full h-[75px] hidden md:flex-layout bg-gray-200 dark:bg-slate-900 mx-auto px-5 lg:px-10 pl-4 py-5 z-40'>
              ...
              {userContext.isLoggedIn ? (
                <>
                  ...
                  <Link to="#" className='flex items-center justify-center gap-x-2 text-base' onClick={logoutHandler}>
                    <HiOutlineUserCircle />
                    <span className="tracking-tighter"> خروج از سیستم </span>
                  </Link>
                </>
              ) :

                                ...
                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <input type="number" id="first_product" className="bg-gray-50 w-14 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0" value={itemBasket.count} required onChange={(e) => ChangeProductCountHandler(e)} />
                                            </div>
                                    ...
                                    <td className="px-4 py-4">
                                        <a href="#" className="font-medium text-red-600 text-2xl dark:text-red-500 hover:underline"> <MdOutlineDeleteOutline /> </a>
                                    </td>
                                </tr>
                            ))}
                        </tbody>

...
import { productInitialValue } from '../CourseInfo/productInfo';
                        ...
                        <tbody>
                            {cart?.map((itemBasket, index) => (
                                <tr key={itemBasket._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td className="p-3">
                                        <img src={itemBasket.images[0]} className="w-16 md:w-32 max-w-full max-h-full" alt="Apple Watch" />
                                    </td>
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex items-center">
                                            <button className="inline-flex items-center justify-center p-1 me-3 text-sm font-medium h-6 w-6 text-gray-500 bg-white border border-gray-300 rounded-full focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button" onClick={() => decreaseCount(index)}>
                                            ...
                                            <button className="inline-flex items-center justify-center h-6 w-6 p-1 ms-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-full focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button" onClick={() => increaseCount(index)}>
                                                <span className="sr-only">Quantity button</span>
                                    ...
                                    <td className="px-4 py-4">
                                        <a href="#" className="font-medium text-red-600 text-2xl dark:text-red-500 hover:underline"
                                            onClick={removeProduct}> <MdOutlineDeleteOutline /> </a>
                                    </td>
                                </tr>
                            ))}
                        </tbody>

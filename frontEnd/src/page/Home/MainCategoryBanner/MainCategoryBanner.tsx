  ...
  return (
    <section className='category-banner w-[90%] mx-auto'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 text-white'>
        <Link  to="/Category-info/category/محصولات پیشنهادی-0" className='category-banner-item1 bg-cover bg-center flex flex-col items-start justify-center pr-7 md:pr-12 rounded-2xl h-[142px] md:h-[248px]'>
        ...
        <Link  to="/Category-info/category/محصولات پیشنهادی-0" className='category-banner-item2 bg-cover bg-center flex flex-col items-start justify-center pr-7 md:pr-12 rounded-2xl h-[142px] md:h-[248px]'>

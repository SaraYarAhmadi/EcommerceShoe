...
export default function MainInstallmentSale() {
  return (
    <section className='products-discount w-[90%] mx-auto pt-6 lg:pt-24'>
      <div className='category-banner-item3 bg-center bg-cover bg-blend-normal flex items-center w-full h-full justify-center border-px rounded-3xl shadow-xl overflow-hidden'>
        <div className='w-full h-full flex items-center p-6 md:p-10'>
          <div className='flex items-center gap-x-3 md:gap-x-6'>
            ...
            <Link to="/Category-info/category/محصولات پیشنهادی-0" className='w-full text-white'>
